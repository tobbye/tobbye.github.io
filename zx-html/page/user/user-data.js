...
var config = {
	...
	lines: [
		{order: 1, value: 948670, nexu: "无关系的", uid: 'd110001', name: '李刚猛', ladd: 18, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['身份标签1', '身份标签2']},
		{order: 2, value: 699972, nexu: "无关系的", uid: 'd110002', name: '王坚强', ladd: 20, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['排名标签1', '排名标签2']},
		{order: 3, value: 690663, nexu: "无关系的", uid: 'd110002', name: '张雄壮', ladd: 17, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['阶层标签1', '阶层标签2']},
		{order: 4, value: 582830, nexu: "无关系的", uid: 'd110004', name: '章威武', ladd: 12, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
		{order: 5, value: 414480, nexu: "无关系的", uid: 'd110005', name: '徐福贵', ladd: 17, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['评价标签1', '评价标签2']},
		{order: 6, value: 341222, nexu: "无关系的", uid: 's110006', name: '赵铁柱', ladd: 15, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['理财专家', '投资顾问']},
		{order: 7, value: 202098, nexu: "无关系的", uid: 's110007', name: '赵铁牛', ladd: 15, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['理财专家', '投资顾问']},
		{order: 8, value: 132256, nexu: "无关系的", uid: 's110008', name: '赵铁蛋', ladd: 15, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['理财专家', '投资顾问']},
	],
};
...
{date:"2019年9月26日", time:"12时00分", desc:"提现本金125元", unit:"[ZX]官方助手(18阶)"},
{date:"2019年9月26日", time:"09时55分", desc:"投入资金6阶*1倍", unit:"[ZX]官方助手(18阶)"},
...
{name:"和谐社会", desc:"今日完成一次投入资金和抢夺资金操作", prect:"100%", value: "完满达成！"},
{name:"丰收日", desc:"今日完成一次抢夺红包操作", prect:"100%", value: "完满达成！"},
