...
{title: '', vice:'',
lines: [
{uid: 'd310001', name: '某新手淘金者', ladd: 3, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
{uid: 'd310002', name: '某低阶淘金者', ladd: 7, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['评价展示1', '评价展示2']},
{uid: 's310001', name: '某新手赞助商', ladd: 6, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
{uid: 's310002', name: '某低阶赞助商', ladd: 5, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['评价展示1', '评价展示2']},
{uid: 'd310003', name: '某中阶淘金者', ladd: 13, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['阶层展示1', '阶层展示2']},
{uid: 'd310004', name: '某高阶淘金者', ladd: 19, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['身份认证1', '身份认证2']},
{uid: 'd310005', name: '某大师淘金者', ladd: 22, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
{uid: 's310003', name: '某中阶赞助商', ladd: 12, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['阶层展示1', '阶层展示2']},
{uid: 's310004', name: '某高阶赞助商', ladd: 17, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['身份认证1', '身份认证2']},
{uid: 's310005', name: '某大师赞助商', ladd: 21, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
]},
]},
...
{uid: 's110005', name: '萌萌部落格', ladd: 17, tag: ['处女座', '完美主义者', '被害妄想症'], mark: ['二次元', '中二病']},
{uid: 's110006', name: '萌萌家族', ladd: 15, tag: ['大萌', '二萌', '小萌'], mark: ['武林萌主', '天下第一萌']},
{uid: 's210001', name: '萌萌宠物店', ladd: 7, tag: ['柯基', '哈士奇', '萨摩耶'], mark: ['人狗情未了', '宠物医院']},
...
{uid: 's210009', name: '萌萌汽修', ladd: 16, tag: ['流动补胎', '保养', '洗车'], mark: ['金牌修理师', '金牌理发师']},
]},
