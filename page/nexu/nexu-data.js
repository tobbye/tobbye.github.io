...
lines: [
{uid: 's110004', name: '苹果Apple', ladd: 18, tag: ['MacPro', 'XDRDisplay', 'ProStand'], mark: ['科技公司', '苹果不香吗']},
{uid: 's110004', name: '腾讯Tencent', ladd: 18, tag: ['王者荣耀', '英雄联盟', '地下城与勇士'], mark: ['游戏公司', '氪金变强']},
...
{uid: 'd120004', name: '二狗子的三叔', ladd: 8, tag: ['空标签', '空标签', '空标签'], mark: ['二狗俱乐部', '二狗家族']},
{uid: 'd120004', name: '二狗子的二姨夫', ladd: 8, tag: ['空标签', '空标签', '空标签'], mark: ['二狗俱乐部', '二狗家族']},
{uid: 'd120008', name: '二狗子的七舅姥爷', ladd: 12, tag: ['哎哟', '卧槽', '这年轻人'], mark: ['二狗俱乐部', '二狗家族']},
{uid: 'd120008', name: '二狗子的远方大表哥', ladd: 14, tag: ['老铁', '双击', '666'], mark: ['空标签', '空标签']},
]},
]},
...
{uid: 'd110002', name: '章威武', ladd: 12, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['成就标签1', '成就标签2']},
{uid: 'd110003', name: '张雄壮', ladd: 17, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['阶层标签1', '阶层标签2']},
{uid: 'd110004', name: '王坚强', ladd: 20, tag: ['自定义标签1', '自定义标签2', '自定义标签3'], mark: ['排名标签1', '排名标签2']},
