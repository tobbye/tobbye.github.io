...
let tempData = {
    ...
    searchData: [],
    userData: {
        d10001:{name:'陈晴晴',ladd:13,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['阶层展示1','阶层展示2']},
        d10002:{name:'叶梦梦',ladd:7,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['称号标签1','称号标签2']},
        d10003:{name:'王嫚嫚',ladd:6,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['排名标签1','排名标签2']},
        d10004:{name:'胡泱秧',ladd:3,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['成就标签1','成就标签2']},
        d10005:{name:'邓小丽',ladd:5,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['评价展示1','评价展示2']},
        d10006:{name:'赵素华',ladd:19,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['身份认证1','身份认证2']},
        d10007:{name:'黎桂清',ladd:22,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['成就标签1','成就标签2']},
        d10008:{name:'章威威',ladd:12,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['阶层展示1','阶层展示2']},
        d10009:{name:'崔慧珍',ladd:17,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['身份认证1','身份认证2']},
        d10010:{name:'鲍青青',ladd:21,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['成就标签1','成就标签2']},
        d10011:{name:'汤小英',ladd:21,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['成就标签1','成就标签2']},
        d10012:{name:'张沙沙',ladd:21,tag:['自定义标签1','自定义标签2','自定义标签3'],mark:['成就标签1','成就标签2']},
